export default function Sidenav (){
    return(
        <>
        <div style={{display:"flex", justifyContent:"space-between", alignItems:"center",flexDirection:"column", border:"1px solid #E1E1E7", width:"5%", height:"70vh",paddingTop:'1%', borderBottom:"none"}}>
